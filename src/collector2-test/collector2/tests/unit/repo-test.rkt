...
(module+ test
  ...
  (check-equal? (url-string->path-string "http://example.com/") "/.")
  (check-equal? (url-string->path-string "http://example.com/asd/fgh/jkl")
                "/asd/fgh/jkl")
  (check-equal? (url-string->path-string "http://example.com/asd/fgh/jkl/")
                "/asd/fgh/jkl/.")
  ...
  (check-equal? (url-top "http://xyz@example.com/") "xyz@example.com")
  (check-equal? (url-top "http://xyz@example.com/asd/fgh/jkl")
                "xyz@example.com")

  (check-equal? (url-top "http://example.com:123") "example.com:123")
  (check-equal? (url-top "http://example.com:123/") "example.com:123")
  (check-equal? (url-top "http://example.com:123/asd/fgh/jkl")
                "example.com:123")
  ...
  (check-equal? (string->repo "https://github.com/asd-mirror/asd.git")
                "asd-mirror/asd")
  (check-equal? (string->repo "https://github.com/asd-mirror/asd.git#trunk")
                "asd-mirror/asd")
  (check-equal? (string->repo "https://gitlab.com/asd-project/asd/asd.git")
                "asd-project/asd/asd")
  (check-equal?
  ...
  (check-equal?
   (query-path
    "https://github.com/asd-mirror/asd.git?path=asd/asd-doc/asd-doc#trunk")
   "asd/asd-doc/asd-doc")
  )
